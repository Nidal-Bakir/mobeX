  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<StoreBloc, StoreState>(
        listenWhen: (previous, current) =>
            current is StoreFollowStateLoadFailure ||
            current is StoreFollowStateChangeFailure ||
            current is StoreFollowStateChangSuccess,
        ...
        builder: (context, state) {
          ...
          return ChoiceChip(
            ...
            backgroundColor: _localIsFollowing
                ? Theme.of(context).accentColor
                : Colors.white,
            visualDensity: VisualDensity.compact,
            selectedColor: _localIsFollowing
                ? Theme.of(context).accentColor
                : Colors.white,
