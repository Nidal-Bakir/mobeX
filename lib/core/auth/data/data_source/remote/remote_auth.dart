  ...
  Future<UserProfile> _getUserProfileFromApi(String endPoint) async {
    ...
    if (ForTestClass.isAStore) {
      res = await Future.value(Response(
          '{"token":"123abc","user_name":"nidal","balance":12000,"profile_image":"assets/images/rand_img/store/5.jpg","phone":"1234567890","city":"home","address":"alware 22st","first_name":"nidal","last_name":"bakir","account_status":"active","user_store":null}',
          200));
      ...
      res = await Future.value(Response(
          '{"token":"123abc","user_name":"nidal","balance":12000,"profile_image":"assets/images/rand_img/store/5.jpg","phone":"1234567890","city":"home","address":"alware 22st","first_name":"nidal","last_name":"bakir","account_status":"active","user_store":{"store_name":"nidal store","bio":"my bio","available_assets":12000,"frozen_assets":2000,"over_all_profit":15000}}',
          200));
    }
